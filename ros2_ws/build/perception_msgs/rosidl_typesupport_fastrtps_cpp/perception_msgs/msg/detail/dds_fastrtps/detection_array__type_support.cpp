...
#include "perception_msgs/msg/detail/detection_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const perception_msgs::msg::Detection &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  perception_msgs::msg::Detection &);
size_t get_serialized_size(
  const perception_msgs::msg::Detection &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const perception_msgs::msg::DetectionArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  perception_msgs::msg::DetectionArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Detection(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = perception_msgs::msg::DetectionArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: detections
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      perception_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.detections[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        perception_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.detections[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Detection(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const perception_msgs::msg::DetectionArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<perception_msgs::msg::DetectionArray *>(
    untyped_ros_message);
...
{
  return &perception_msgs::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, perception_msgs, msg, DetectionArray)() {
  return &perception_msgs::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
